      ...
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8">
        ...
        <form 
          ...
          <div>
            ...
            <input
              type="text"
              className="mt-1 block w-1/2   shadow-sm focus:ring-gray-900 focus:border-gray-900"
          ...
          <div>
            ...
            <textarea
              rows="5"
              className="mt-1 block w-full   shadow-sm focus:ring-gray-900 focus:border-gray-900"
